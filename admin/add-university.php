...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = mysqli_prepare($conn, "INSERT INTO universities (name, country, city, type, description) VALUES (?, ?, ?, ?, ?)");
    mysqli_stmt_bind_param($stmt, "sssss", $name, $country, $city, $type, $description);
...
<body>
    <div class="container">
        <a class="back-link" href="dashboard.php">← Dashboard'a dön</a>
